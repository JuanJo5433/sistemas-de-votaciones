...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style_index.css"> <!--archivo de tipo css-->
...
<body>
     ...
     <div class="form-container">
        ...
        <form action="insertar.php" class="formulario" id="formulario" method="POST"> <!--Permite ingresar los datos en la BD-->
        ...
        <div class="botones">
            <a><input type="submit" value="Siguiente" form="formulario"></a>
