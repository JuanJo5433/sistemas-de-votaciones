<?php
require_once('../../../get/get_candidatos_representantes_sena.php'); //Obtiene la informacion del candidato
?>
    ...
    <div class="container">
        ...
        if (!empty($candidatos)) {
            foreach ($candidatos as $candidato) {
                $id = $candidato["id_candidato_representante_sena"];
                ...
                echo '<a href="actualizar.php?id_candidato_representante_sena=' . $id . '" class="btn-gradient">Editar</a>';
                // Agrega la confirmación de eliminación con el nombre del candidato
                echo '<a href="delete.php?id_candidato_representante_sena=' . $id . '" class="btn-gradient" onclick="return confirm(\'¿Estás seguro de eliminar a ' . $nombre . '?\')">Eliminar</a>';
                echo '</div>';
                echo '</div>';
            }
            //mensajes de alerta
