<?php
require_once('../../../get/get_candidatos_gobernador.php'); //Obtiene la informacion del candidato
...
<head>
    ...
    <title>Mostrar candidatos gobernacion</title> <!--Titulo de la pagina-->
</head>
...
<body>
    ...
    <div class="container">
        ...
        if (!empty($candidatos)) {
            foreach ($candidatos as $candidato) {
                $id = $candidato["id_candidato_gobernador"];
                ...
                echo '<a href="actualizar.php?id_candidato_gobernador=' . $id . '" class="btn-gradient">Editar</a>';
                // Agrega la confirmación de eliminación con el nombre del candidato
                echo '<a href="delete.php?id_candidato_gobernador=' . $id . '" class="btn-gradient" onclick="return confirm(\'¿Estás seguro de eliminar a ' . $nombre . '?\')">Eliminar</a>';
                echo '</div>';
                echo '</div>';
            }
            //Mensajes de alerta
    ...
    <!--Ventana emergente, evento de alerta-->
    <script>
        document.getElementById('redirectButton').addEventListener('click', function() {
            window.location.href = 'voto/gobernacion.php';
        });
    </script>
</body>
</html>