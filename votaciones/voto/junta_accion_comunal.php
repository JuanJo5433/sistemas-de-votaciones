...
require_once '../../get/get_candidatos_junta_accion_comunal.php';
?>
...
<meta charset="UTF-8"><!--Permite caracteres especiales-->
    ...
    <title>Votaciones Junta Acción Comunal</title>
</head>
<body>
    ...
    <form id="votingForm" method="post" action="procesar_votos/procesar_voto_jac.php">
        <input type="hidden" name="tipo_formulario" value="jac">
