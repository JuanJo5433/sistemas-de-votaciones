...
require_once '../../get/get_candidatos_representantes_sena.php';
?>
...
<meta charset="UTF-8"><!--Permite caracteres especiales-->
    ...
    <link rel="stylesheet" type="text/css" href="css/estilo_tiposvotaciones.css">
    <script src="js/scripts.js"></script>
    <title>Votaciones Representante Sena</title>
</head>
<body>
    ...
    <form id="votingForm" method="post" action="procesar_votos/procesar_voto_representante_sena.php">
        <input type="hidden" name="tipo_formulario" value="representantes_sena">
