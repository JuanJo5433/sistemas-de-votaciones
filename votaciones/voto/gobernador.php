...
require_once '../../get/get_candidatos_gobernador.php';
?>
...
<meta charset="UTF-8"><!--Permite caracteres especiales-->
    ...
    <title>Votaciones Gobernador</title>
</head>
<body>
    ...
    <form id="votingForm" method="post" action="procesar_votos/procesar_voto_gobernador.php">
        <input type="hidden" name="tipo_formulario" value="gobernador">
