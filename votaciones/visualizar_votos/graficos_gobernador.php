...
$conexion = connection();
// Consulta SQL para obtener datos de votos para Gobernador y candidatos.
$sql = "SELECT v.id_voto, v.cantidad_votos, c.nombre_completo, c.documento
        FROM votos_gobernador v
        INNER JOIN candidatos_gobernador c ON v.id_candidato = c.id_candidato_gobernador";
...
<body>
    ...
    <!-- Tabla para mostrar los votos de Gobernador. -->
    <div class="table">
        <div id="wrapper">
            <h1>Tabla de votos Gobernador</h1>
