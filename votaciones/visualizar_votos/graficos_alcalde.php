...
$conexion = connection();
// Consulta SQL para obtener datos de votos para Alcalde y candidatos.
$sql = "SELECT v.id_voto, v.cantidad_votos, c.nombre_completo, c.documento
        FROM votos_alcalde v
        INNER JOIN candidatos_alcalde c ON v.id_candidato = c.id_candidato_alcalde";
...
<body>
    ...
    <!-- Tabla para mostrar los votos de Alcalde. -->
    <div class="table">
        <div id="wrapper">
            <h1>Tabla de votos Alcalde</h1>
