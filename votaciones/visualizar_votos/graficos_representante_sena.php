...
$conexion = connection();
// Consulta SQL para obtener datos de votos representante del SENA y candidatos.
$sql = "SELECT v.id_voto, v.cantidad_votos, c.nombre_completo, c.documento
        FROM votos_representante_sena v
        INNER JOIN candidatos_representante_sena c ON v.id_candidato = c.id_candidato_representante_sena";
...
<head>
    ...
    <title>Gráfica de Barra con PHP y MySQL</title><!--Titulo de la pagina-->
...
<body>
    ...
    <!-- Tabla para mostrar los votos de representante del SENA. -->
    <div class="table">
        <div id="wrapper">
            <h1>Tabla de votos representante SENA</h1>
